...
class ShapeMeta(pydantic.main.ModelMetaclass):
    ...
    def __repr__(self):    # noqa: B902
        ...
        clsname = "shape" if self.__GENERATED_SHAPE__ else self.__name__
...
class Enum(enum.Enum):
    ...
    def __eq__(self, o):
        ...
        return self.value == o.value if hasattr(o, "value") else super().__eq__(o)
